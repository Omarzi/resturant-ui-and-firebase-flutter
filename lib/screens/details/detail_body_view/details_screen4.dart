...
class DetailsBodyScreen4 extends StatefulWidget {
  @override
  State<DetailsBodyScreen4> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsBodyScreen4> {
  int count = 1;
  int prize = 12;
  int total = 0;
  int cart = 1;
