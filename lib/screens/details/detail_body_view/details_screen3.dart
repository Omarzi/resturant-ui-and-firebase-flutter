...
class DetailsBodyScreen3 extends StatefulWidget {
  @override
  State<DetailsBodyScreen3> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsBodyScreen3> {
  int count = 1;
  int prize = 12;
  int total = 0;
  int cart = 1;
