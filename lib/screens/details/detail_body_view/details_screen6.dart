...
class DetailsBodyScreen6 extends StatefulWidget {
  @override
  State<DetailsBodyScreen6> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsBodyScreen6> {
  int count = 1;
  int prize = 12;
  int total = 0;
  int cart = 1;
