...
class DetailsBodyScreen5 extends StatefulWidget {
  @override
  State<DetailsBodyScreen5> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsBodyScreen5> {
  int count = 1;
  int prize = 12;
  int total = 0;
  int cart = 1;
