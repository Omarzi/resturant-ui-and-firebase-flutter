...
class DetailsBodyScreen1 extends StatefulWidget {
  @override
  State<DetailsBodyScreen1> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsBodyScreen1> {
  int count = 1;
  int prize = 12;
  int total = 0;
  int cart = 1;
