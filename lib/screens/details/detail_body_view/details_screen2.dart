...
class DetailsBodyScreen2 extends StatefulWidget {
  @override
  State<DetailsBodyScreen2> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsBodyScreen2> {
  int count = 1;
  int prize = 12;
  int total = 0;
  int cart = 1;
